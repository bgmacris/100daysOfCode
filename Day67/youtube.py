...
def add_to_list(lista, METHOD='GET', data=None):
	...
	if METHOD == 'GET':
		if lista in iter_lists:
			canciones = []
			with open(f'/home/kali/Documents/YouTube/listas/{lista}.csv', 'r', newline='') as file:
	...
	if METHOD == 'PUT':
		try:
			with open(f'/home/kali/Documents/YouTube/listas/{lista}.csv', 'w', newline='') as file:
	...
	if METHOD == 'ADD':
		try:
			with open(f'/home/kali/Documents/YouTube/listas/{lista}.csv', 'a', newline='') as file:
				spamwriter = csv.writer(file, delimiter=',', quotechar='|')
				for d in data:
	...
	if METHOD == 'DELETE':
		try:
			os.remove(f'/home/kali/Documents/YouTube/listas/{lista}.csv')
		except Exception as e:
			return e
...
if __name__ == '__main__':
	...
	while RUN:
		if search_s:
			cancion = input("Introduce nombre de la cancion o Ver/selecionar lista (L): ")
			search_s = False
